...
import CreateEspecialities from "../especialities/create";
import { Tooltip, TooltipContent, TooltipTrigger } from "../ui/tooltip";
import { Dialog, DialogContent, DialogTrigger } from "../ui/dialog";
import ModalEliminarEspeciality from "../especialities/delete";
import EditEspeciality from "../especialities/edit";
import DetailsEspeciality from "../especialities/details";
...
export default function Especialidades() {
    ...
    const [editEspecialityModal, setEditEspecialityModal] = useState(false)
    const [detailsEspecialityModal, setDetailsEspecialityModal] = useState(false)
    ...
    return (
        <>
            <CreateEspecialities onClose={() => setCreateModalIsOpen(false)} isOpen={createModalIsOpen} />
            <EditEspeciality onClose={() => setEditEspecialityModal(false)} isOpen={editEspecialityModal} itemSelected={itemSelected} />
            <DetailsEspeciality onClose={() => setDetailsEspecialityModal(false)} isOpen={detailsEspecialityModal} itemSelected={itemSelected} />
                    ...
                    <table className="w-full md:table-fixed border-collapse ">
                        <thead className="h-10 ring-1 ring-[#EDEFF6]" >
                            <tr className=" place-items-center text-[#707EAE]">
                                ...
                                <th className="text-start px-2 py-2 font-semibold">Departamento</th>
                                                ...
                                                <div className="flex justify-end px-3 space-x-2 ">
                                                    <Tooltip >
                                                        <TooltipTrigger>
                                                            ...
                                                            <button onClick={() => {
                                                                setDetailsEspecialityModal(true),
