...
export default function Avaliadores() {
    ...
    async function getAvaliators() {
        try {

            const url = `usuarios?role=AVALIADOR`;
    ...
    return (
        <>
            <CreateUser onClose={() => setCreateModalIsOpen(false)} isOpen={createModalIsOpen} role="Avaliador" />
                    ...
                    <table className="w-full md:table-fixed border-collapse ">
                        <thead className="h-10 ring-1 ring-[#EDEFF6]" >
                            <tr className=" place-items-center text-[#707EAE]">
                                ...
                                <th className="text-start px-2 py-2 font-semibold">email</th>
                                ...
                                filteredHistorics?.length > 0 ? filteredHistorics?.map((item: any) =>
                                    <>
                                        <tr className="border-t-1 py-2 border-[#EBECEF] hover:bg-[#F5F6FA] duration-300 text-[#143163]">
                                            ...
                                            <td className="text-start py-2 px-2 pt-4 border-b-[1px] border-b-[#EDEFF6]">
                                                {(item?.especialidades && item?.especialidades[0]?.nome) ?? "N/A"}
                                            </td>
                                            <td className="text-start py-2 px-2 pt-4 border-b-[1px] border-b-[#EDEFF6]">
                                            ...
                                            <td className="text-start py-2 border-b-[1px] border-b-[#EDEFF6]">
                                                <div className="flex justify-end px-3 space-x-2 ">
                                                    ...
                                                    <button onClick={() => {
                                                        ...
                                                        <div className=" hover:bg-[#E02E2E] hover:text-[#fff] bg-[#FFE3E3]
                                                                 text-[#E02E2E] duration-150 p-2 rounded-lg cursor-pointer">
                                    ...
                                    <tr>
                                        <td colSpan={5} className="text-center py-6">Nenhum movimento encontrado no momento.</td>
                                    </tr>
                            }
