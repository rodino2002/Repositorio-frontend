...
return (
    <>
        ...
        <div className="min-h-screen w-full flex bg-white">
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="-mt-5 sm:-mt-7 lg:-mt-8">
                        ...
                        <p
                            ...
                            "
                        >
                            Seja bem-vindo, preencha os campos
                            <br />
                            abaixo para aceder a sua conta.
                        </p>
                    </div>
                    ...
                    >
                        ...
                        <div className="min-h-5 mt-2">
                            {statusError && (
                                <p className="text-xs sm:text-sm text-[#ED5656]">
                        ...
                        {/* CRIAR CONTA */}
                        <div className="w-full flex flex-col justify-center items-center mt-6 sm:mt-8">
                            <p className="text-[#0B1437] text-sm">
                                Não tem uma conta?
                            </p>
            ...
            >
                <img
                    src={trocaImg ? "/img1.jpg" : "/img2.jpg"}
