...
export default function ModalEliminarEspeciality({ id }: props) {
            ...
            <div className=" p-4 space-y-6  ">
                <div className="space-y-2">
                    ...
                    <div className="text-center text-[#143163] w-full grid place-items-center">
                        <p className="text-[#143163] text-center font-semibold">Tem certeza que pretende <br /> eliminar esta Especialidade?</p>
                    </div>
