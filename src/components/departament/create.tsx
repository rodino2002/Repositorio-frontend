...
export default function CreateDepartament({ onClose, isOpen }: props) {
    ...
    const createDepartament = async (e: any) => {
        e.preventDefault()
            ...
            <Sheet onOpenChange={onClose} open={isOpen}>
                ...
                <SheetContent style={{ minWidth: '35%' }} className="pr-16 pl-16 pt-10 w-full flex-col overflow-y-auto scrollbar-none">
                    <div className="flex justify-between items-center w-full pb-14">
                        <SheetHeader className="text-[#143163] font-semibold text-lg p-0">Criar novo Departamento</SheetHeader>
                    ...
                    <form onSubmit={createDepartament} className="">
