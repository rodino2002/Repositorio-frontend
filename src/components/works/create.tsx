                    ...
                    <form onSubmit={createWork} className="">
                        ...
                        <div className="flex flex-col space-y-2 mt-6">
                            ...
                            <div className=" rounded-lg p-4 bg-white border-2 border-dashed border-[#D4D9EA] flex justify-start items-center space-x-2 ">
                                ...
                                {formDataFiles?.file && <svg className="cursor-pointer" onClick={() => setFormDataFiles(null)} width="20" height="20" viewBox="0 0 24 26" fill="none" xmlns="http://www.w3.org/2000/svg">
